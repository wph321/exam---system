		...
		<header>
			<div class="container">
				<div class="row">
					<div class="col-xs-5">
						<div class="logo">
							<h1><a href="index.jsp">网站管理系统</a></h1>
							<div class="hmeta">
								专注互联网在线考试解决方案
							</div>
						</div>
				...
				<div class="row">
					<div class="col-xs-3">
						<ul class="nav default-sidenav">
							...
							<li>
								<a href="admin/sys-admin-list.jsp"> <i class="fa fa-bar-chart-o"></i> 管理员列表 </a>
							</li>
							<li class="active">
					...
					<div class="col-xs-9">
						...
						<div class="page-content row">
							...
							<form  style="margin-top:40px;" action="addAdmin.action" method="post">
								<div class="form-line " >
									<span class="form-label"><span class="warning-label"></span>用户名：</span>
										<input type="text" class="df-input-narrow" name="admin.loginname"><span class="form-message"></span>
									<br>
								</div>
								<div class="form-line " >
									<span class="form-label"><span class="warning-label"></span>密码：</span>
										<input type="text" class="df-input-narrow" name="admin.loginpass"><span class="form-message"></span>
									<br>
								</div>
									<div class="form-line " >
									<span class="form-label"><span class="warning-label"></span>姓名</span>
										<input type="text" class="df-input-narrow" name="admin.aname"><span class="form-message"></span>
									<br>
								</div>
									<div class="form-line" >
									<span class="form-label"><span class="warning-label"></span>邮箱</span>
										<input type="text" class="df-input-narrow" name="admin.email"><span class="form-message"></span>
									<br>
								</div>
									<div class="form-line " >
									<span class="form-label"><span class="warning-label"></span>电话</span>
										<input type="text" class="df-input-narrow" name="admin.phone"><span class="form-message"></span>
									<br>
								</div>
								<div class="form-line">
