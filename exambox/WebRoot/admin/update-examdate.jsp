	...
	<body>
					...
					<div class="col-xs-9">
						<div class="page-header">
							<h1><i class="fa fa-list-ul"></i> 修改考试时间 </h1>
						</div>
						<div class="page-content row">

							<form  style="margin-top:40px;"  action="updateExamdate.action" method="post">
								<input type="hidden" name="examdate.id" value="${examdate.id}" />
								...
								<div class="form-line form-name" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>考试时间：</span>
										<input type="text" class="df-input-narrow" id="name" name="examdate.edate" value="${examdate.edate}"><span class="form-message"></span>
									<br>
								</div>
