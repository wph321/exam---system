				...
				<div class="row">
					...
					<div class="col-xs-7" id="login-info">
						<c:choose>
							...
							<c:otherwise>
								<a class="btn btn-primary" href="login.jsp">用户注册</a>
								<a class="btn btn-success" href="register.jsp">登录</a>
							</c:otherwise>
						</c:choose>
					</div>
				</div>
			...
			<div class="container">
				<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
					<ul class="nav navbar-nav">
						<li>
							<a href="index.jsp"><i class="fa fa-home"></i>网站首页</a>
						</li>
						<li>
				...
				<div class="row">
					<div class="col-xs-3">
						<ul class="nav default-sidenav">
							<li>
								<a href="admin/user-list.jsp"> <i class="fa fa-list-ul"></i> 会员管理 </a>
							</li>
							<li class="active">
					...
					<div class="col-xs-9">
						...
						<div class="page-content row">
							...
							<form id="user-add-form" style="margin-top:40px;" action="adminaddStudent.action" enctype="multipart/form-data" method="post">
								<div class="form-line form-job-type" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>真实姓名</span>
									<input type="text" class="df-input-narrow" name="student.uname"><span class="form-message"></span>
									<span class="form-message"></span>
									<br>
								</div>
								<div class="form-line form-username" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>用户名：</span>
										<input type="text" class="df-input-narrow" name="student.loginname"><span class="form-message"></span>
									<br>
								</div>
								<div class="form-line form-password" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>密码：</span>
										<input type="text" class="df-input-narrow" name="student.loginpass"><span class="form-message"></span>
									<br>
								</div>
								<div class="form-line" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>电话</span>
											<input type="text" class="df-input-narrow" name="student.phone"><span class="form-message"></span>
										<span class="form-message"></span>
									<br>
								</div>
								<div class="form-line " style="display: block;">
									<span class="form-label"><span class="warning-label"></span>邮箱</span>
											<input type="text" class="df-input-narrow" name="student.email"><span class="form-message"></span>
										<span class="form-message"></span>
									<br>
								</div>
								<div class="form-line " style="display: block;">
									<span class="form-label"><span class="warning-label"></span>头像</span>
										<input type="file" class="df-input-narrow" name="image"><span class="form-message"></span>
									<br>
								</div>
