			...
			<div class="container">
				...
				role="navigation">
					<ul class="nav navbar-nav">
						<li>
							<a href="index.jsp"><i class="fa fa-home"></i>主页</a>
						</li>
						<li>
							<a href="start-exam.jsp"><i class="fa fa-edit"></i>试题练习</a>
						</li>
						<li>
							<a href="student/usercenter.jsp"><i class="fa fa-dashboard"></i>会员中心</a>
						</li>
						<li>
							<a href="student/setting.jsp"><i class="fa fa-cogs"></i>个人设置</a>
						</li>
					</ul>
				</nav>
			</div>
					...
					<div class="col-md-12">
						<div class="lrform">
							...
							<div class="form">
								...
								<form class="form-horizontal" action="loginAdmin.action" method="post">
									<!-- Username -->
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="password" class="form-control" name="student.loginpass">
										</div>
									</div>
									<!-- Buttons -->
									<div class="form-group">
