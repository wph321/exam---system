...
<html>
  <head>
		...
		<script type="text/javascript">
			...
			function readChart(){
				//var divdom = document.getElementById("page-link-content");
				location.href = addChartStudent.action;
				//divdom.innerHTML = '<img src="images/zk.jpg" style="margin-left: -50px;margin-top: 30px"/>';
			}
		</script>
						...
						<div class="page-content row">
							<div id="question-list">
								<table class="table-striped table">
									<thead>
										<tr>
											<td width="80px">科目名称</td><td width="120px">分数</td><td align="center" width="200px">时间</td><td width="80px">查看报告</td>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${gradeList}" var="grade">
											<tr>
												...
												<td align="center">
													<fmt:formatDate value="${grade.time}" pattern="yyyy-MM-dd"/> 												</td>
												<td><a href="findCard.action?grade.id=${grade.id }">查看</a></td>
							...
							<div id="page-link-content">
								<ul class="pagination pagination-sm"><a href="addChartStudent.action">查看图表</a></ul>
