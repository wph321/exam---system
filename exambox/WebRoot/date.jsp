...
<html>
	<head>
		...
		<style type="text/css">
		h2.top_title{border-bottom:none;background:none;text-align:center;line-height:32px;color:white; font-size:45px}
	...
	<div  style="height:135px;">
		...
		<div class="full-slider" style="padding-top: 20px;">
			<h2 class="top_title">近期考试<br/></h2>

<section id="cd-timeline" class="cd-container">
<c:forEach items="${examdateList }" var="ed">
	<div class="cd-timeline-block">
		<div class="cd-timeline-img cd-picture">
		</div>
		<div class="cd-timeline-content">
			<h2>${ed.subject.sname }</h2>
			<!-- <p>${ed.subject.sdetail }</p> -->
			<p>最近有${fn:length(ed.subject.grades) }人次参加过练习</p>
			<a href="findoneSubject.action?sid=${ed.subject.id }" class="cd-read-more" target="_blank">立即练习</a>
			
			<span class="cd-date" style="color: white;font-size: 28px;"><fmt:formatDate value="${ed.edate}" type="date"/></span>
		</div>
	</div>
</c:forEach>	
